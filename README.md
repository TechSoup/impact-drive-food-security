...
Persona (WHO)  →  Job to be Done (the OUTCOME)  →  Use Cases / User Stories (BUILDABLE)
                       + Business case = market sizing + impact (WHY it's worth building)
```
...
These artifacts stoke imagination; they don't replace talking to the community. The proven approach is to
**build *with* the people who have the problem.** See [start-here/methodology.md](start-here/methodology.md).
