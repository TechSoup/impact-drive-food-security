...
3. **Pick a Job to be Done.** Each [job](../jobs-to-be-done/) is an outcome someone needs, with a business
   ...
   - client → [Find convenient, dignified food support](../jobs-to-be-done/find-convenient-dignified-food.md)
   - provider → [Distribute all donated food each session](../jobs-to-be-done/distribute-donated-food.md)
     or [Distribute the right food to the right pantries before it spoils](../jobs-to-be-done/distribute-right-food-right-pantry.md)
