...
> **Status: PLACEHOLDER — to be authored by Caravan Studios.** This is the tried-and-trusted part; we're
> leaving it for Caravan to fill in rather than inventing it here.

This is **not prescriptive** and not a product-management playbook. It's a set of recommendations —
*things that might work* — distilled from Caravan Studios' methodology for designing technology *with*
communities, broken into accessible, actionable steps.

The intent (from the 6/29 discussion), to be expanded:

- **Why trust us (ethos).** TechSoup and Caravan have done this work across many organizations; some of the
...
> To be filled in by Caravan: the concrete steps, framing, and any templates that make co-design easy to
> adopt.
