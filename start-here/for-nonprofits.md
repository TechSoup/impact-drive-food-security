# I'm at a nonprofit / CSR team — where do I begin?

This repo is written so you don't have to think like a developer to get value from it. The same problems
appear in **plain, nonprofit language** alongside their developer translation.

- **See yourself here.** The [personas/](../personas/) and [sector/landscape.md](../sector/landscape.md) are
  the sector in your words — food banks, pantries, cupboards, and the people they serve.
- **Recognize the problems.** Each [job to be done](../jobs-to-be-done/) describes the need in nonprofit
