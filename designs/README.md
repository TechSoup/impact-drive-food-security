# Designs — community-generated technology designs
...
> organizations to validate and improve what you build together.**

| Design | Design question (how might we…) | Personas in journey maps |
|---|---|---|
| [One System, One World](one-system-one-world.md) | align data across unified systems so we can trust and benefit from shared data and meet administrative requirements | Marguerita, Dan |
| [Personal Pantry](personal-pantry.md) | map the capacity of the food-distribution experience to connect people to food while preserving privacy and dignity | Reba, Gladys, Dan |

**Journey-map model** (the 4-stage lifecycle used at the event — a lighter cousin of AAARRR):
