...
|---|---|---|
| [Reba](reba.md) | client | Single parent of 3; wants anonymity, convenience, good timing |
| [Marguerita](marguerita.md) | client | Working poor, two jobs; making hard bills-vs-food choices |
| [Gladys](gladys.md) | provider | 75, volunteer; runs a twice-monthly church pantry with limited tech |
| [Dan](dan.md) | provider | Food-bank program manager; moves food out before it spoils |

Each persona links to the **Job(s) to be Done** it drives and the **design(s)** it appears in.
